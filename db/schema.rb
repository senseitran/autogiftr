...
ActiveRecord::Schema.define(version: 20140902084730) do
  ...
  create_table "gift_occaisions", force: true do |t|
    t.integer  "gift_id"
    t.integer  "occaision_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "gift_occaisions", ["gift_id"], name: "index_gift_occaisions_on_gift_id"
  add_index "gift_occaisions", ["occaision_id"], name: "index_gift_occaisions_on_occaision_id"
